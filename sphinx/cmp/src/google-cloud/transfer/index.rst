...
If you have several dozens of GCP projects or less, the simplest way is to switch billing manually for each of the projects one by one. We've created screenshot-illustrated :doc:`guide <transfer-manually>` to walk you through.
...
Please follow the guide :doc:`here <bulk-transfer-using-wizard>`.
...
Please follow the steps from the :doc:`illustrated-guide <terraform>`.
